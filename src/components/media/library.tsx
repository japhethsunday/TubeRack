        ...
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0">
            ...
            <p className="mt-0.5 text-xs text-muted-text">
              {asset.kind} · {asset.source === "local-draft" ? "on-device draft" : asset.source === "upload-session" ? "upload" : "provider request"}
    ...
    <div className="space-y-4">
      ...
      {assets.length === 0 ? (
        <EmptyState
          ...
          body="Generate on-device drafts, upload session files, or save provider requests. Everything here belongs to this project."
        />
      ) : shown.length === 0 ? (
