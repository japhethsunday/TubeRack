...
export const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        status: "live",
        phase: "Phase 12",
        blurb: "Connected channel analytics, uploads, scheduling.",
      },
      {
        slug: "calendar",
        label: "Calendar",
        ...
        status: "live",
        phase: "Phase 12",
        blurb: "Content schedule, reminders, .ics export.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        slug: "paying-niches",
        label: "Most Paying Niches",
        href: "/intelligence/paying-niches",
        icon: BadgeDollarSign,
        status: "live",
        phase: "Phase 13",
        blurb: "Rank niches by earning potential from live YouTube data.",
      },
      {
        slug: "channel-creator",
      ...
      },
      {
        ...
        status: "live",
        phase: "Phase 12",
        blurb: "What's rising this week, daily digest.",
      },
      {
        slug: "competitors",
        label: "Competitors",
        ...
        status: "live",
        phase: "Phase 12",
        blurb: "Breakout alerts, cadence, patterns.",
      },
      {
        slug: "research",
        label: "Research",
      ...
      },
      {
        ...
        status: "live",
        phase: "Phase 12",
        blurb: "Rotate live thumbnails, keep the winner.",
      },
      {
        slug: "seo",
        label: "SEO",
